<template>
  <button @click="visible = true" class="flex items-center gap-2 text-sm">
    <svg
  ...
  <Drawer
    ...
    position="bottom"
    style="height: auto"
    pt:root="!rounded-t-xl"
  >
    <div class="mb-3">
      <div class="mb-2 pb-2 border-b border-gray-200">
        <label class="text-sm" for="">نوع تراکنش</label>
        <p class="text-gray-400 mt-1">انتخاب نوع تراکنش</p>
      </div>
      <div class="mb-2 pb-2 border-b border-gray-200">
        <label class="text-sm" for="">وضعیت تراکنش</label>
        <p class="text-gray-400 mt-1">انتخاب وضعیت تراکنش</p>
      </div>
      <div class="grid grid-cols-2 gap-2">
        ...
        >
          <div class="text-xs">
            <h4 class="text-gray-400">انتخاب تاریخ</h4>
            از تاریخ
          </div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    <Button label="اعمال فیلتر" pt:root="!w-full" />
  </Drawer>
</template>
