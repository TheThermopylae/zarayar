  ...
  <div>
    ...
    >
      <form @submit.prevent class="space-y-2">
        <div>
          <label for="submit">ثبت کننده حواله</label>
          <input
            type="text"
            id="submit"
        ...
        <div>
          <label for="receiver">دریافت کننده حواله</label>
          <input
            type="text"
            id="receiver"
            class="p-2 rounded-10 border border-stroke block mt-1.5 w-full"
        ...
        <div>
          <label for="time">زمان ثبت حواله</label>
          <input
            type="text"
            id="time"
            class="p-2 rounded-10 border border-stroke block mt-1.5 w-full"
        ...
        <div>
          <label for="number-file">شماره سند</label>
          <input
            type="text"
            id="number-file"
            class="p-2 rounded-10 border border-stroke block mt-1.5 w-full"
        ...
        <div>
          <label for="user-status">وضعیت حواله</label>
          <Select
            v-model="form.status"
            :options="userStatus"
            pt:root="w-full !rounded-10 !bg-white !shadow-none !border-[#00000026] !mt-1.5"
