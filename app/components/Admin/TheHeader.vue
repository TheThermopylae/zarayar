<template>
  <header
    class="p-3 border-b border-[#DEDEDE] items-center fixed w-full bg-white z-10 top-0"
  >
    <div class="flex justify-between items-center z-20 relative bg-white">
      ...
      >
        <button
          class="px-2 py-1.5 rounded-10 text-graydark bg-[#EFEFEF] flex items-center gap-2 transition-colors"
    ...
    <Transition
      ...
      leave-active-class="grid transition-all duration-300 ease-in"
      leave-from-class="grid-rows-[1fr] opacity-100"
      leave-to-class="grid-rows-[0fr] opacity-0"
    >
      <div v-if="route.path == '/admin' && showMenu" class="grid">
        <div class="overflow-hidden min-h-0">
          <div class="grid grid-cols-3 gap-2 flex-wrap text-xs mt-3">
            <button
